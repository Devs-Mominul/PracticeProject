                        ...
                        <form action="{{ route('login') }}" method="POST" class="mt-5">
                            ...
                            <div class="mb-4 form-group">
                                ...
                                <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1">
                                            <svg class="text-gray-600 icon icon-xs" fill="currentColor"
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-4 d-flex justify-content-between align-items-top">
                                    ...
                                    <div><a href="{{ route('password.request') }}" class="text-right small">Lost
                                            password?</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
                                <button type="submit" class="text-white btn btn-secondary fw-bolder">Sign in</button>
                            </div>
                        </form>
